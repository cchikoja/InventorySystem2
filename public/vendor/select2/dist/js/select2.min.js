...
!function (n) {
  ...
  var e = function () {
    ...
    function l(e, t) {
      var n, r, i, s, o, a, l, c, u, d, p, h = t && t.split("/"), f = y.map, g = f && f["*"] || {};
      if (e) {
        for (o = (e = e.split("/")).length - 1, y.nodeIdCompat && w.test(e[o]) && (e[o] = e[o].replace(w, "")), "." === e[0].charAt(0) && h && (e = h.slice(0, h.length - 1).concat(e)), u = 0; u < e.length; u++) if ("." === (p = e[u])) e.splice(u, 1), u -= 1; else if (".." === p) {
    ...
    return e && e.requirejs || (e ? n = e : e = {}, m = {}, v = {}, y = {}, _ = {}, i = Object.prototype.hasOwnProperty, a = [].slice, w = /\.js$/, f = function (e, t) {
      var n, r = c(e), i = r[0], s = t[1];
      return e = r[1], i && (n = D(i = l(i, s))), i ? e = n && n.normalize ? n.normalize(e, function (t) {
        return function (e) {
          return l(e, t)
        }
      }(s)) : l(e, s) : (i = (r = c(e = l(e, s)))[0], e = r[1], i && (n = D(i))), {
        f: i ? i + "!" + e : e,
        n: e,
        pr: i,
        p: n
      ...
      var i, s, o, a, l, c, u, d = [], p = typeof n;
      if (c = S(r = r || e), "undefined" == p || "function" == p) {
        for (t = !t.length && n.length ? ["require", "exports", "module"] : t, l = 0; l < t.length; l += 1) if ("require" === (s = (a = f(t[l], c)).f)) d[l] = g.require(e); else if ("exports" === s) d[l] = g.exports(e), u = !0; else if ("module" === s) i = d[l] = g.module(e); else if (b(m, s) || b(v, s) || b(_, s)) d[l] = D(s); else {
      ...
      return t = t || function () {
      }, "function" == typeof n && (n = r, r = i), r ? s(h, e, t, n) : setTimeout(function () {
        s(h, e, t, n)
      }, 4), o
    }, o.config = function (e) {
      return o(e)
      ...
      i.Extend = function (e, t) {
        ...
        i.displayName = r.displayName, s.prototype = new function () {
          this.constructor = s
        };
      ...
      e.prototype.on = function (e, t) {
        ...
        var n = s(t), r = t.style.overflowX, i = t.style.overflowY;
      ...
      return f.Extend(r, f.Observable), r.prototype.render = function () {
        ...
        this.$results.attr("id", n), t.on("results:all", function (e) {
          ...
          if (!(n <= 0)) {
            ...
            var s = l.$results.offset().top, o = i.offset().top, a = l.$results.scrollTop() + (o - s);
          ...
          if (!(n >= t.length)) {
            ...
            var i = l.$results.offset().top + l.$results.outerHeight(!1), s = r.offset().top + r.outerHeight(!1),
        ...
        if (0 !== e.length) {
          var t = this.$results.find("[aria-selected]").index(e), n = this.$results.offset().top, r = e.offset().top,
            i = this.$results.scrollTop() + (r - n), s = r - n;
      ...
      return r.Extend(s, r.Observable), s.prototype.render = function () {
      ...
      return a.Extend(n, e), n.prototype.render = function () {
        ...
        if (this.clear(), 0 !== e.length) {
          for (var t = [], n = 0; n < e.length; n++) {
            var r = e[n], i = this.selectionContainer(), s = this.display(r, i);
            i.append(s);
        ...
        if (!this.isDisabled()) {
          ...
          if (0 !== n.length) {
            ...
            if (this.trigger("clear", s), s.prevented) this.$element.val(i); else {
              for (var o = 0; o < r.length; o++) if (s = {data: r[o]}, this.trigger("unselect", s), s.prevented) return void this.$element.val(i);
      ...
      return l.Extend(n, e), n.prototype.current = function (e) {
        ...
        this.$element.children().each(function () {
          if ("option" === this.tagName.toLowerCase() || "optgroup" === this.tagName.toLowerCase()) {
            var e = c(this), t = s.item(e), n = s.matches(r, t);
            null !== n && i.push(n)
          }
        }), e({results: i})
      ...
      function e(e, t, n) {
        ...
        if (void 0 !== s && (this.insertTag = s), e.call(this, t, n), Array.isArray(r)) for (var o = 0; o < r.length; o++) {
          var a = r[o], l = this._normalizeItem(a), c = this.option(l);
      ...
      return e.prototype.query = function (e, c, u) {
        ...
        this._removeOldTags(), null != c.term && null == c.page ? e.call(this, c, function e(t, n) {
          for (var r = t.results, i = 0; i < r.length; i++) {
            var s = r[i], o = null != s.children && !e({results: s.children}, !0);
      ...
      return e.prototype.bind = function (e, t, n) {
        ...
        for (var i = n.get("tokenSeparators") || [], s = t.term, o = 0, a = this.createTag || function (e) {
      ...
      return e.prototype.bind = function (e, t, n) {
        ...
        var e = f(window), t = this.$dropdown[0].classList.contains("select2-dropdown--above"),
          n = this.$dropdown[0].classList.contains("select2-dropdown--below"), r = null, i = this.$container.offset();
        ...
        var o = this.$dropdown.outerHeight(!1), a = e.scrollTop(), l = e.scrollTop() + e.height(), c = a < i.top - o,
          u = l > i.bottom + o, d = {left: i.left, top: s.bottom}, p = this.$dropdownParent;
      ...
      return n.prototype.apply = function (e) {
        ...
        var n = e.language, r = this.defaults.language, i = t.prop("lang"), s = t.closest("[lang]").prop("lang"),
        ...
        for (var n = new g, r = 0; r < e.length; r++) {
          ...
          if ("string" == typeof s) try {
            ...
            try {
              s = this.defaults.amdLanguageBase + s, i = g.loadPath(s)
            } catch (e) {
          ...
          } else i = l.isPlainObject(s) ? new g(s) : s;
          n.extend(i)
        }
        return n
      ...
      return e.prototype.fromElement = function (e) {
        ...
        for (var i = 0; i < e[0].attributes.length; i++) {
          var s = e[0].attributes[i].name, o = "data-";
      ...
      return e
    }), e.define("jquery.select2", ["jquery", "jquery-mousewheel", "./select2/core", "./select2/defaults", "./select2/utils"], function (i, e, s, t, o) {
