...
@section('content')
    <div class="container wrapper py-3 px-4">
        <p>
            <a href="{{ URL::previous() }}" class="my-2"><span class="fa fa-arrow-circle-left"></span>Go Back</a>
        </p>
                ...
                <div class="col-md-5">
                    <div class="card rounded-0 wrapper">
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{route('contracts.edit', $contract->id)}}" class=""> Edit
                                Contract <span class=" fa fa-edit"></span></a>
                            </p>
                                ...
                                <tbdody>
                                    ...
                                    @foreach($linkedContracts as $links)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('contracts.show', $links->object)}}" target="">Open <span
                                                        class="fa fa-folder-open"></span></a> &nbsp;
