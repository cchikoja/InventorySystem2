...
<body>
<div id="app" style="font-family: Nunito !important;">
    <div class="preloader"></div>
    <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
        <div class="container">
            <a class="navbar-brand" href="{{ url('/') }}" style="color: darkslateblue">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <!-- Left Side Of Navbar -->
                <ul class="navbar-nav mr-auto" style="font-size: 13px !important;">
                    <li class=""><a class="nav-link {{$page=='assets'?'active':''}}" href="{{route('assets.index')}}">assets <span
                                class="fa fa-assets"></span></a></li>
                    <li class=""><a class="nav-link {{$page=='allocations'?'active':''}}" href="{{route('allocations.index')}}">Allocations <span
                                class="fa fa-users"></span></a></li>
                    <li class=""><a class="nav-link {{$page=='contracts'?'active':''}}" href="{{route('admin.contracts')}}">Contracts <span
                                class="fa fa-users"></span></a></li>
                    <li class=""><a class="nav-link {{$page=='users'?'active':''}}" href="{{route('users.index')}}">users <span
                                class="fa fa-users"></span></a></li>
                </ul>
                    ...
                    @else
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                ...
                                <a class="dropdown-item" href="{{route('admin.settings')}}">My account</a>
