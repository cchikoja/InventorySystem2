...
<body>
    <div id="app" style="font-family: 'Nunito', sans-serif">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        @if(Auth::user())
                        <li class=""><a class="nav-link" href="{{route('home.assets')}}">Assets <span class="fa fa-assets"></span></a></li>
                        <li class=""><a class="nav-link" href="{{route('home.allocations')}}">Allocations <span class="fa fa-assets"></span></a></li>
                        @endif
                    </ul>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                            @if (Route::has('login'))
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('login') }}">{{ __('Login') }} <span class="fa fa-sign-in-alt"></span></a>
                                </li>
                            @endif
                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item" href="{{route('home.settings')}}">My account</a>
