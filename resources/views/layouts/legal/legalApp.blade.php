        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav mr-auto">
                    @if(Auth::user())
                    <li class=""><a class="nav-link {{$page=='contracts'?'active':''}}" href="{{route('contracts.index')}}">Contracts <span class="fa fa-handshake"></span></a></li>
                    <li class=""><a class="nav-link {{$page=='reports'?'active':''}}" href="{{route('legal.reports')}}">Reports <span class="fa fa-folder"></span></a></li>
                    @endif
                </ul>
                    ...
                    @else
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                ...
                                <a class="dropdown-item" href="{{route('legal.settings')}}" style="font-size: 13px !important;">My account <span class="fa fa-cogs"></span></a>
