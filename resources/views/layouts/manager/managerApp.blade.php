        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav mr-auto">
                    @if(Auth::user())
                        <li class=""><a class="nav-link {{$page=='contracts'?'active':''}}" href="{{route('manager.contracts')}}">Contracts <span class="fa fa-handshake"></span></a></li>
                        <li class=""><a class="nav-link {{$page=='reports'?'active':''}}" href="{{route('manager.reports')}}">Reports <span class="fa fa-file"></span></a></li>
                    @endif
                </ul>
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="{{ route('logout') }}" style="font-size: 13px !important;"
                                   onclick="event.preventDefault();
                                    ...
                                    {{ __('Logout') }} <span class="fa fa-sign-out-alt"></span>
                                </a>
                                <a class="dropdown-item" href="{{route('manager.settings')}}" style="font-size: 13px !important;">My account <span class="fa fa-cogs"></span></a>
