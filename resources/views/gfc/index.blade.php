            ...
            <div class="col-md-10" style="font-size: 13px">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-4">
                            <h6 class="font-weight-bold"> <span class="fa fa-tags"></span>Contracts Overview</h6>
                            <hr>
                            <div class="text-center ml-5 pl-5" style="width: 250px; height: 250px; text-align: center !important;">
                                        ...
                                        <table class="table table-sm table-bordered">
                                            ...
                                            @foreach($expiringContracts as $contract)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{route('gfc.contracts.open',$contract->id)}}" class="" >Open</a> &nbsp;
