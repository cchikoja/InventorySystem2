...
@section('content')
    <div class="container wrapper py-3 px-4">
        ...
        @if($flag == null)
            <a href="{{route('gfc.contracts').'?flag=expired'}}" class="btn btn-primary btn-sm">Expired Contracts <span class="fa fa-exclamation-circle"></span></a>
        @else
            <a href="{{route('gfc.contracts')}}" class="btn btn-primary btn-sm">Active Contracts <span class="fa fa-exclamation-circle"></span></a>
        @endif
            ...
            <table class="table table-sm table-bordered" style="font-size: 13px">
                ...
                @foreach($contracts as $contract)
                    <tr>
                        ...
                        <td>
                            <a href="{{route('gfc.contracts.open',$contract->id)}}" target="">Open</a> &nbsp;
